        ...
        <div className="flex-1 flex flex-col justify-around gap-2">
          <div className="flex flex-col md:flex-row items-center md:justify-between p-3">
            ...
            <input
              ...
              className="p-1 border-2 rounded-b-sm border-[#b6b3b3c1] bg-[#b6b3b31a] text-white text-xl md:w-60"
              value={siteName}
              onChange={(e) => {
          ...
          <div className="flex flex-col md:flex-row items-center md:justify-between p-3">
            ...
            <div className="relative w-full md:w-60 flex items-center">
              <input
                ...
                className="p-1 pr-10 w-full border-2 rounded-b-sm border-[#b6b3b3c1] bg-[#b6b3b31a] text-white text-xl  md:w-60"
                value={passkey}
                onChange={(e) => {
